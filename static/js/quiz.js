...
var right = 0;
var questions = [
    ["Where did AbdulQuawiy & Faozyat meet?", "Spring break, Miami - cliché, we know", "At Columbia University, obviously", "Through a friend who set them up - Hi, Friend! You know who you are ;)", "In the one Anthropology class Keshal took while at Columbia. It was called 'Magic, Witchcraft and Religion'. He thought it 'sounded cool'.", "1"],
    ...
    ["Which of these is a nickname Abdul has for Faozyat?", "Schmoomoo", "Boo Radley", "KP", "Keshal Facial", "All of the above", "5"],
    ["Which of these is a nickname Faozyat has for Abdul? ", "Clown", "Ma", "Booface", "Garfield", "All of the above", "5"],
    ["Over the years, Abdul and Faozyat have had a lot of adventures together. What <i>haven't</i> they done together?", "Climbed a volcano", "Scuba dived in fresh water caves", "Taken a woodworking class", "Gone to a music festival", "All of the above", "3"]
];
